-- Update application decision RPC to support scores and optional cohort assignment
...
begin
    ...
    set
        ...
        review_scores = coalesce(p_scores, review_scores),
...
revoke all on function public.update_application_decision(uuid, uuid, text, text, jsonb, uuid) from public;
grant execute on function public.update_application_decision(uuid, uuid, text, text, jsonb, uuid) to authenticated;
