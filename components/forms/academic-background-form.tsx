...
import { applicationSteps, programChoices } from "@/lib/constants/application";
...
export function AcademicBackgroundForm({ application }: AcademicBackgroundFormProps) {
                ...
                <Card className="border-border/50">
                    <CardHeader className="border-b bg-muted/20">
                        <p className="text-sm text-muted-foreground flex items-center gap-2">
                            ...
                            All academic credentials will be independently verified. Any discrepancy will result in disqualification.
                        </p>
                    </CardHeader>
                    ...
                    <CardContent className="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Select name="programChoice" defaultValue={application?.program_id}>
                                    <SelectTrigger id="program"><SelectValue /></SelectTrigger>
                                    <SelectContent>
                                        {programChoices.map(p => <SelectItem key={p} value={p}>{p}</SelectItem>)}
                                    </SelectContent>
                                </Select>
                                <p className="text-xs text-muted-foreground">Programme placement is subject to assessment results and national strategic needs.</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="school" name="secondarySchool" defaultValue={ab.secondarySchool || ""} placeholder="Full official name of school" required />
                                </div>
                                <div className="grid sm:grid-cols-3 gap-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="waec-year">WAEC/NECO Year *</Label>
                                        <Input id="waec-year" name="waecYear" defaultValue={ab.waecYear || ""} placeholder="e.g. 2021" maxLength={4} required />
                                    </div>
                                    <div className="space-y-2 sm:col-span-2">
                                        <Label htmlFor="waec-grade">WAEC/NECO Results Summary *</Label>
                                        <Input id="waec-grade" name="waecGrade" defaultValue={ab.waecGrade || ""} placeholder="e.g. 8 A1s, including Mathematics and English" required />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="jamb-score" name="jambScore" defaultValue={ab.jambScore || ""} placeholder="e.g. 334" required />
                                    <p className="text-xs text-muted-foreground">Minimum 280 required</p>
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="jamb-year">JAMB Year *</Label>
                                    <Input id="jamb-year" name="jambYear" defaultValue={ab.jambYear || ""} placeholder="e.g. 2022" maxLength={4} required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="institution" name="institution" defaultValue={ab.institution || ""} placeholder="University / Polytechnic name" />
                                </div>
                                <div className="grid sm:grid-cols-3 gap-4">
                                    <div className="space-y-2 sm:col-span-2">
                                        <Label htmlFor="course">Course / Department *</Label>
                                        <Input id="course" name="course" defaultValue={ab.course || ""} placeholder="e.g. Computer Science" />
                                    </div>
                                    <div className="space-y-2">
