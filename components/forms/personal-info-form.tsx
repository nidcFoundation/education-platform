...
export function PersonalInfoForm({ application, profile }: PersonalInfoFormProps) {
                ...
                <Card className="border-border/50">
                    <CardHeader className="border-b bg-muted/20">
                        <p className="text-sm text-muted-foreground flex items-center gap-2">
                            ...
                            All fields marked with * are required. Ensure all information matches your official identification.
                        </p>
                    </CardHeader>
                        ...
                        <div>
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="firstName" name="firstName" defaultValue={pi.firstName || profile.first_name} required />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="middleName">Middle Name</Label>
                                    <Input id="middleName" name="middleName" defaultValue={pi.middleName || ""} />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="lastName">Last Name / Surname *</Label>
                                    <Input id="lastName" name="lastName" defaultValue={pi.lastName || profile.last_name} required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="email" type="email" defaultValue={pi.email || profile.email} disabled />
                                </div>
                                <div className="space-y-2">
                                    <Label htmlFor="phone">Phone Number *</Label>
                                    <Input id="phone" name="phone" type="tel" defaultValue={pi.phone || profile.phone || ""} required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid sm:grid-cols-3 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="dob" name="dob" type="date" defaultValue={pi.dateOfBirth || ""} required />
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="national-id" name="nationalId" defaultValue={pi.nationalId || ""} placeholder="11-digit NIN" maxLength={11} required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Select name="stateOfOrigin" defaultValue={pi.stateOfOrigin || profile.state_of_origin}>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Input id="lga" name="lgaOfOrigin" defaultValue={pi.lgaOfOrigin || ""} placeholder="Enter your LGA" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    ...
                                    <Input id="address" name="address" defaultValue={pi.address || ""} placeholder="House number, street name" required />
                                </div>
                                <div className="grid sm:grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <Label htmlFor="city">City *</Label>
                                        <Input id="city" name="city" defaultValue={pi.city || ""} placeholder="City" required />
                                    </div>
                                    <div className="space-y-2">
                    ...
                    <CardFooter className="border-t bg-muted/10 flex justify-between p-5">
                        <Button type="button" variant="outline" className="gap-2" onClick={(e) => handleSave(e, false)} disabled={loading}>
