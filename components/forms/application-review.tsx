...
export function ApplicationReview({ profile, application, documents }: ApplicationReviewProps) {
    ...
    const handleSubmit = async () => {
        ...
        setLoading(true);
        // TODO: Implement submitApplication server action
        setTimeout(() => {
            setLoading(false);
        ...
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-xl text-sm text-amber-800">
                ...
                <div>
                    ...
                    <p className="mt-0.5 text-amber-700">
                        Once you click "Submit Application", your application is locked and forwarded to the Selection Board.
                    </p>
                </div>
            </div>
            ...
            <ReviewSection title="Personal Information" icon={FileText} editHref="/application/step-1">
                <div className="space-y-3">
                    <InfoRow label="Full Name" value={`${pi.first_name} ${pi.last_name}`} />
                    <Separator />
            ...
            <ReviewSection title="Academic Background" icon={GraduationCap} editHref="/application/step-2">
                <div className="space-y-3">
                    <InfoRow label="Preferred Programme" value={application?.program_id} />
                    <Separator />
            ...
            <ReviewSection title="Essays" icon={ScrollText} editHref="/application/step-3">
                <div className="space-y-4">
                    {[
                        ...
                        { label: "Your Vision for National Contribution", value: essays.nationalContribution },
                        { label: "Demonstrated Leadership", value: essays.leadershipExample },
            ...
            <Card className="border-primary/30 bg-primary/5">
                <CardContent className="p-5 space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                        By submitting this application, I, <strong>{pi.first_name} {pi.last_name}</strong>, hereby certify that all information provided is true, accurate, and complete.
                    </p>
